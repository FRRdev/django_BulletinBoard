...
SECRET_KEY = 'y-l+s@d4*uekca@#=$4)-u1hxy(-yt)f=0n8f^6giy=9qwmt(4'
...
EMAIL_PORT = 2525
EMAIL_HOST_USER = "mixail.critsyn@mail.ru"
EMAIL_HOST_PASSWORD = "zahita183"
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
DEFAULT_FROM_EMAIL = 'mixail.critsyn@mail.ru'
