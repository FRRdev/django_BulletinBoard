...
from .views import index,user_activate,DeleteUserView
from .views import BBLoginView,BBLogoutView,ChangeUserInfoView,BBPasswordChangeView,RegisterUserView,RegisterDoneView
from .views import profile,by_rubric,detail,profile_bb_detail,profile_bb_add,profile_bb_delete,profile_bb_change
